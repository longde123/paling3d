package  org.paling3d.objects.proto
{
	...
	*/
	public class ObjectContainer3D extends EventDispatcher
	{
		...
		*/
		...
		public function addChildren( parent :Object3D ):ObjectContainer3D
		{
			for each( var child:Object3D in parent.children )
			{
		...
		/**
		* Removes the specified child Object3D instance from the child list of the DisplayObjectContainer3D instance.
		* </p>
		...
		*/
		public function getChildByName( name:String, recursive:Boolean = false ):Object3D
		{
			if(recursive)
		...
		/**
		* Removes the child Object3D instance that exists with the specified name, from the child list of the DisplayObjectContainer3D instance.
		* </p>
		...
		*/
		public function removeChildByName( name:String ):Object3D
		{
		...
		*/
		 ...
		 */ 
		private function findChildByName(name:String, parent:Object3D = null):Object3D
		{
			parent = parent || Object3D(this);
			if(!parent)
				return null;
			if(parent.name == name)
				return parent;
			for each(var child:Object3D in parent.children)	
			{
				var obj:Object3D = findChildByName(name, child);
				if(obj) 
					return obj;
			}
			return null;
