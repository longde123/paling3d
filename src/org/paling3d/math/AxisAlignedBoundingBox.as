package  org.paling3d.math
{
	...
	public class AxisAlignedBoundingBox
	{
		...
		{
			_vertices = new Array();
			_vertices.push(new Vector3D(minX, minY, minZ));
			_vertices.push(new Vector3D(minX, minY, maxZ));
			_vertices.push(new Vector3D(minX, maxY, minZ));
			_vertices.push(new Vector3D(minX, maxY, maxZ));
			_vertices.push(new Vector3D(maxX, minY, minZ));
			_vertices.push(new Vector3D(maxX, minY, maxZ));
			_vertices.push(new Vector3D(maxX, maxY, minZ));
			_vertices.push(new Vector3D(maxX, maxY, maxZ));
		}
		...
		public static function createFromVertices(vertices:Vector.<Point3D>):AxisAlignedBoundingBox
		{
